...
namespace DevConnect.Infrastructure.Migrations
{
    ...
    [Migration("20250720181545_UpdateRoleToUser")]
    partial class UpdateRoleToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevConnect.Domain.AuthUseCase.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DevConnect.Domain.AuthUseCase.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DevConnect.Domain.AuthUseCase.ApplicationUser", b =>
                {
                    b.HasOne("DevConnect.Domain.AuthUseCase.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DevConnect.Domain.AuthUseCase.ApplicationUser", null)
                        .WithMany()
